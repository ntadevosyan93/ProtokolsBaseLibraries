...
-- =============================================
CREATE PROCEDURE [dbo].[GetDogovorsByUserSelectStatFromDate]
...
begin
	...
	where del = 0 and idm_empl = @idm_user and some_status =1 and r_date between @date_start and @date_end 
