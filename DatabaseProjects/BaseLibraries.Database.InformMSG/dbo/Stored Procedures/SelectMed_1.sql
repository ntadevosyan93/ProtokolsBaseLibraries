...
-- =============================================
CREATE PROCEDURE [dbo].[SelectMed_1]
...
BEGIN
 ...
 DECLARE @Error nvarchar(MAX);
  begin try
	 ...
	 where idm_med_ToOrder is not null and idm_depart=@idm_depart and a.del=0  and b.GlobalParentID=@idm_med 
	  and idm_buy_form=@idm_buy_form --and month_order =@month and year_order=@year
	 FOR XML PATH(''))  AS VARCHAR(MAX)) 

	if(@c_buy!='')
		(select a.id,a.GlobalParentID,a.idm_parent,klass_value as textED,a.idm_ED, a.articul,a.defect,
		NULL as [count],NULL as comment,NULL as idm_status,a.idm_1C,a.[text] as name,
		c.[text] as p_name, dbo.f_GetIsGroupMedicine_Order(a.id) as IsGroup,a.IsNew
		...
		union 
		select idm_med_ToOrder,a.GlobalParentID,a.idm_parent,klass_value as textED,a.idm_ED, a.articul,a.defect,
		[count],comment,idm_status, a.idm_1C,a.[text] as name, c.[text] as p_name, dbo.f_GetIsGroupMedicine_Order(a.id) as IsGroup ,a.IsNew
		...
		and b.del=0 --and month_order =@month and year_order=@year
		 and idm_med_ToOrder is not null and idm_depart=@idm_depart and idm_buy_form=@idm_buy_form)
			order by id
	else 
		select a.id,a.GlobalParentID,a.idm_parent,klass_value as textED,a.idm_ED, a.articul,a.defect,
		NULL as [count],NULL as comment,NULL as idm_status,a.idm_1C,a.[text] as name,
		...
		and (a.IsNew =0 or a.user_in=@user_in)
	end try
	begin catch 
