CREATE PROCEDURE [dbo].[WT$T13_LIST_DOLJN_Group]
...
IF ( @idm_partner = 0 ) 
  BEGIN 
   ...
   select idm_empl, fio_short, KAD$DOLJN.text as doljn, KAD$WORK_TIME.idm_doljn 
	...
	AND ( KAD$WORK_TIME.idm_doljn in (select idm_doljn from KAD$WORK_TIME_DOLJN_GROUP where idm_parent = @idm_groupDoljn ) ) 
