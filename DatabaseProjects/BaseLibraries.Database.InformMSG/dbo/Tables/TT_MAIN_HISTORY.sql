CREATE TABLE [dbo].[TT$MAIN_HISTORY] (
    [Id]              INT           NOT NULL,
    [user_in]         VARCHAR (50)  NULL,
    [date_in]         DATETIME      CONSTRAINT [DF_TT$MAIN_HISTORY_date_in] DEFAULT (getdate()) NULL,
    ...
    [del]             INT           CONSTRAINT [DF_TT$MAIN_HISTORY_del] DEFAULT ((0)) NULL,
