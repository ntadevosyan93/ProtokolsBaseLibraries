CREATE VIEW dbo.View$OS$TT_ACTIVE_IT
AS
SELECT     dbo.RM$OS.text AS os_text, dbo.RM$OS.id AS os_id, dbo.RM$OS.idm_otdel, dbo.DEPARTMENTS.text AS DEPARTMENT_text, dbo.TT$MAIN.status AS tt_status_id, 
                      ...
                      dbo.TT$MAIN.idm_activity AS tt_activity
...
WHERE     (dbo.TT$MAIN.status <> 4) AND (dbo.KLASS.klass_name = 'tt_trouble_status')
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View$OS$TT_ACTIVE_IT';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View$OS$TT_ACTIVE_IT';
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Or = 1350
         Or = 1350
         Or = 1350', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View$OS$TT_ACTIVE_IT';
