CREATE VIEW dbo.View$SSMP$TEAM_BRIGADE_AVTO
AS
SELECT     dbo.SSMP$TEAM.id, dbo.SSMP$EMPLOYEE.fio, dbo.AVTO.text, dbo.AVTO.phone AS phone_avto, dbo.SSMP$EMPLOYEE.phone AS phone_doc, dbo.SSMP$BRIGADE.mesto, 
                      dbo.AVTO.gos_nomer + ', ' + dbo.SSMP$BRIGADE.mesto + ' (' + dbo.SSMP$EMPLOYEE.fio + ')' AS full_name, dbo.SSMP$TEAM.date_start, dbo.SSMP$TEAM.date_in
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View$SSMP$TEAM_BRIGADE_AVTO';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'View$SSMP$TEAM_BRIGADE_AVTO';
