...
CREATE view [dbo].[View$history_Req_candidat] as 
...
(select [id], [id_OLD], [date_in], [user_in], [idm_req], [idm_candidate], [status], [del], [type_employment], [user_cur], [date_cur]
From HRM$REQ_CANDIDATE_HISTORY
union  
select 0, id [id_old], [date_in], [user_in], [idm_req], [idm_candidate], [status], [del], [type_employment], [user_cur], [date_cur]
From HRM$REQ_CANDIDATE) rc
